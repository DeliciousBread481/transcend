...
import huige233.transcend.util.MKRRenderUtil;
...
public class RenderTimeAccelerator extends Render<EntityTimeAccelerator>
{
    ...
    public void doRender(EntityTimeAccelerator entity, double x, double y, double z, float entityYaw, float partialTicks)
    {
        if(entity != null) {
            ...
            float progress = (2) * (ModEventHandler.clientAnimationCounter + partialTicks);
    ...
    public static class Factory implements IRenderFactory<EntityTimeAccelerator>
    {
        @Override
