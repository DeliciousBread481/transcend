...
public class HeartRenderHandler {
    private static final ResourceLocation HEARTS = new ResourceLocation("transcend", "textures/gui/hearts.png");
    private static final ResourceLocation ABSORB = new ResourceLocation("transcend", "textures/gui/absorb.png");
    private static final ResourceLocation VANILLA = Gui.ICONS;
    ...
    public void renderHealthbar(RenderGameOverlayEvent.Pre event) {
        ...
        this.mc.getTextureManager().bindTexture(VANILLA);
    ...
    private void renderExtraAbsorption(int xBasePos, int yBasePos, EntityPlayer player) {
        int potionOffset = getPotionOffset(player);
        this.mc.getTextureManager().bindTexture(ABSORB);
